...
-- 컬럼(속성)의 데이터 타입과 입력하는 데이터 타입이 일치해야함.
-- 위배시 도메인 제약조건 위반으로 삽입 불가
...
-- Error Code: 1292. Incorrect date value: '날짜아님' for column 'birth_date' at row 
...
-- 4. 여러 컬럼 동시에 삽입
INSERT INTO employees (emp_no, birth_date,first_name, last_name,gender,hire_date)
VALUES(3,'2000-05-22','관순','유','F','2024-05-22'),(4,'2000-05-22','사임당','임','F','2024-05-22');

-- (대량 데이터 삽입)
-- INSERT INTO ... SELECT .. 문법
-- INSERT INTO 대상테이블 SELECT * FROM 원본 테이블
-- 1. 데이터 구조가 완전히 일치하는 데이터 삽입 가능
-- 2. (주의점) 죽복 데이터가 발생할 경우 제약조건 위배로 오류
